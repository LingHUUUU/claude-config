# Parallel computing[¶](#parallel-computing "Permalink to this headline")
...
See this [introduction to parallelism](https://smileipic.github.io/Smilei/Understand/parallelization.html#decomposition-of-the-box).
...
>
> [![_images/node.svg](_images/node.svg)](_images/node.svg)
...
## Physical configuration[¶](#physical-configuration "Permalink to this headline")

Download the input file <beam_2d.py>.
A small plasma ball is set with an initial velocity \(v\_x=0.3\)
and traverses the box.

---

## Setup the tutorial[¶](#setup-the-tutorial "Permalink to this headline")

As explained in the [setup page](basics_setup.html#runsimulation), you should make a new directory
...
## Splitting the box[¶](#splitting-the-box "Permalink to this headline")
...
## Introduce Smilei’s parallelism[¶](#introduce-smileis-parallelism "Permalink to this headline")
...
## Imbalance[¶](#imbalance "Permalink to this headline")
...
## Imbalance and distributed memory[¶](#imbalance-and-distributed-memory "Permalink to this headline")
...
## Balancing the load between processes[¶](#balancing-the-load-between-processes "Permalink to this headline")
...
## Realistic configuration[¶](#realistic-configuration "Permalink to this headline")
