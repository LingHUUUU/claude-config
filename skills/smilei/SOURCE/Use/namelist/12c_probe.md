...
origin[¶](#origin "Link to this definition")
:   Type:
    :   A list of floats, of length equal to the simulation dimensionality.

    The coordinates of the origin of the probe grid

corners[¶](#corners "Link to this definition")

vectors[¶](#vectors "Link to this definition")
:   Type:
    ...
    When using `vectors`, the coordinates relative to [`origin`](#origin "origin") must be specified.

number[¶](#number "Link to this definition")
:   Type:
...
fields[¶](#id79 "Link to this definition")
:   Default:
...
time\_integral[¶](#time_integral "Link to this definition")
:   Default:
    :   `False`
...
datatype[¶](#id80 "Link to this definition")
:   Default:
    :   `"double"`
