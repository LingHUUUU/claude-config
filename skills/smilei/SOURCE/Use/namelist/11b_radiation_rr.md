...
minimum\_chi\_continuous[¶](#minimum_chi_continuous "Link to this definition")
:   Default:
    :   1e-3

    Threshold on the particle quantum parameter *particle\_chi*. When a particle has a
    quantum parameter below this threshold, radiation reaction is not taken
    into account.

minimum\_chi\_discontinuous[¶](#minimum_chi_discontinuous "Link to this definition")
:   Default:
    :   1e-2

    Threshold on the particle quantum parameter *particle\_chi* between the continuous
    and the discontinuous radiation model.

table\_path[¶](#table_path "Link to this definition")
:   Default:
    :   `""`
...
Niel\_computation\_method[¶](#Niel_computation_method "Link to this definition")
:   Default:
    :   `"table"`
