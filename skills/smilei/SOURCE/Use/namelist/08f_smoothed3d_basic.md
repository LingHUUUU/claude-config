...
> \widetilde{E}(x,y,z,n=0) = \frac{E\_0}{2\sqrt{\pi}} \sqrt{\frac{f\_0}{f\_0-x}} \mathrm{e}^{ik\_0x}\mathrm{e}^{-\frac{ik\_0(y^2+z^2)}{2(f\_0-x)} } \times \text{...} \\
> \text{...} \sum\_{N\_y} \sum\_{N\_z} \mathrm{e}^{i (\varphi\_N+\delta\_N)} \big[\mathrm{erf}(\mathrm{e}^{-\frac{i \pi}{4}} K\_0(x)\cdot (a\_{N\_y+1} - \frac{yf\_0}{f\_0-x})) - \mathrm{erf}(\mathrm{e}^{-\frac{i \pi}{4}} K\_0(x)\cdot (a\_{N\_y} - \frac{yf\_0}{f\_0-x})) \big] \times \text{...} \\
> \text{...} \big[\mathrm{erf}(\mathrm{e}^{-\frac{i \pi}{4}} K\_0(x)\cdot (b\_{N\_z+1} - \frac{zf\_0}{f\_0-x})) - \mathrm{erf}(\mathrm{e}^{-\frac{i \pi}{4}} K\_0(x)\cdot (b\_{N\_z} - \frac{zf\_0}{f\_0-x})) \big]
...
> box\_side[¶](#id32 "Link to this definition")
> :   Type:
>     :   a string
>
>     Default:
...
>
> a0[¶](#id33 "Link to this definition")
> :   Type:
>     :   double
>
>     Default:
>
>     The normalized vector potential at focus. Note that \(E\_0 = (a\_0 \omega/N\_{tot}) / \sqrt{k\_0 (dy)^2 / (2 L\_f \pi^2) } / \sqrt{k\_0 (dz)^2 / (2 L\_f \pi^2)}\) with \(dy=D/N\_y\) and \(dz=D/N\_z\)
>     and where D is the effective aperture of the optical system (typically the size of the phase plate)
>
> omega[¶](#id34 "Link to this definition")
> :   Type:
>     :   double
>
>     Default:
...
>
> focus[¶](#id35 "Link to this definition")
> :   Type:
...
>
> incidence\_angle[¶](#id36 "Link to this definition")
> :   Type:
>     :   double
>
>     Default:
...
>
> polarization\_phi[¶](#id37 "Link to this definition")
> :   Type:
>     :   double
>
>     Default:
...
>
> ellipticity[¶](#id38 "Link to this definition")
> :   Type:
>     :   double
>
>     Default:
...
>
> phase\_zero[¶](#id39 "Link to this definition")
> :   Type:
>     :   double
>
>     Default:
...
>
> Lf[¶](#id40 "Link to this definition")
> :   Type:
>     :   double
>
>     Default:
...
>
> fnumber[¶](#id41 "Link to this definition")
> :   Type:
>     :   double
>
>     Default:
...
>
> N[¶](#id42 "Link to this definition")
> :   Type:
>     :   a list of two *int*
>
