...
Before you launch **Smilei**, [write a namelist file](namelist.html)
...
## The `smilei` executable[¶](#the-smilei-executable "Link to this heading")

[Compiling Smilei](compile) creates an executable file `smilei` in the source directory.
...
to run **Smilei** on several MPI processes:
...
When running **Smilei**, the output log will remind you how many MPI processes and openMP threads
your simulation is using.

---

## Running in *test mode*[¶](#running-in-test-mode "Link to this heading")
...
## Directory management[¶](#directory-management "Link to this heading")
...
Knowing that **Smilei** generally writes out all the results in the current directory,
...
## Using the provided script[¶](#using-the-provided-script "Link to this heading")
...
## Running on large clusters[¶](#running-on-large-clusters "Link to this heading")
...
## Running on GPU-equiped nodes[¶](#running-on-gpu-equiped-nodes "Link to this heading")
...
(see [this example for the adastra cluster](https://github.com/SmileiPIC/Smilei/issues/672#issuecomment-1820677606)).
