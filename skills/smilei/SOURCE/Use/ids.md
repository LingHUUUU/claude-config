# Identification of tracked particles[¶](#identification-of-tracked-particles "Link to this heading")

[Tracked particles](namelist.html#diagtrackparticles) require an identification number (ID) in
...
output files for the [tracked particles diagnostic](namelist.html#diagtrackparticles). These
