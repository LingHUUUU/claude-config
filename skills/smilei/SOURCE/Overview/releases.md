...
## Get Smilei[¶](#get-smilei "Link to this heading")

**Clone the latest version of Smilei from** [GitHub](https://github.com/SmileiPIC/Smilei):

```
git clone https://github.com/SmileiPIC/Smilei.git
```

*Learn about Git* [here](https://git-scm.com/doc).

You can find older, [unsupported versions here](https://github.com/SmileiPIC/Smilei/releases)

---

## Changes made in the repository (not released)[¶](#changes-made-in-the-repository-not-released "Link to this heading")
...
- **Features**:
  ...
  - Low dispersion Maxwell solver `"Terzani"` from [this article](https://doi.org/10.1016/j.cpc.2019.04.007) in `"AMcylindrical"` geometry.
...
## Ongoing projects[¶](#ongoing-projects "Link to this heading")
...
## Release 5.1[¶](#release-5-1 "Link to this heading")
...
## Release 4.8[¶](#release-4-8 "Link to this heading")
...
## Release 4.7[¶](#release-4-7 "Link to this heading")
...
## Release 4.6[¶](#release-4-6 "Link to this heading")
...
- Some [Profiles](../Use/profiles.html) can be imported from a file
...
## Release 4.5[¶](#release-4-5 "Link to this heading")
...
- Changes:
  ...
  - Correction for [Binary collisions & reactions](../Understand/collisions.html) as suggested in [[Higginson2020]](../Understand/collisions.html#higginson2020)
- Bugfixes:
...
## Release 4.4[¶](#release-4-4 "Link to this heading")

- Changed radiation tables: see [the doc](../Understand/radiation_loss.html).

  - Old tables are not valid anymore, input files must be updated.
  - Default tables are now embebded in the code
  - Possibility to read external generated by an [external tool](../Use/tables.html) (more efficient and stable)
- New `RadiationSpectrum` diagnostics available (see [the doc](../Understand/radiation_loss.html))
...
## Release 4.3[¶](#release-4-3 "Link to this heading")
...
## Release 4.2[¶](#release-4-2 "Link to this heading")
...
- Bugfixes:
  ...
  - Laser [`a0`](../Use/namelist.html#id33 "a0") normalization to [`omega`](../Use/namelist.html#id59 "omega")
...
## Release 4.1[¶](#release-4-1 "Link to this heading")
...
Since version 4.1, the [definition of macro-particle weights](../Understand/units.html#weights)
...
- [Laser envelope model](../Use/namelist.html#laser-envelope)
...
## Release 3.5[¶](#release-3-5 "Link to this heading")

- [Laser defined in tilted plane](../Use/laser_offset.html)
- Bugfixes: Field diagnostic subgrid, Scalar diagnostic PoyInst,
  MPI tags for large number of patches

---

## Release 3.4.1[¶](#release-3-4-1 "Link to this heading")

- Ionization considering a user-defined rate

---

## Release 3.4[¶](#release-3-4 "Link to this heading")
...
## Release 3.3[¶](#release-3-3 "Link to this heading")

- **Major** [syntax changes](../syntax_changes.html) in the namelist
...
## Release 3.2[¶](#release-3-2 "Link to this heading")
...
- Partial support of the [OpenPMD](https://www.openpmd.org) standard
...
- The input “output\_dir” is not supported anymore

---

## Release 3.0[¶](#release-3-0 "Link to this heading")
...
## Release 2.3[¶](#release-2-3 "Link to this heading")
...
## Release 2.2[¶](#release-2-2 "Link to this heading")
...
## Release 1.0[¶](#release-1-0 "Link to this heading")
